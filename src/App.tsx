    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-50 flex flex-col font-sans">
      ...
      <main className="flex-1 w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-2 self-start md:self-auto">
            {isAdmin && leads.length > 0 && (
              <div className="relative">
                <motion.button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm skeuo-button hover:skeuo-button-hover active:skeuo-button-active rounded-lg font-bold cursor-pointer text-slate-700 dark:text-slate-200"
                >
                      ...
                      <div className="p-1">
                        ...
                        {["New", "Contacted", "Qualified", "Proposal", "Won", "Lost"].map((status) => (
                          <button
                            ...
                            className="w-full text-left px-3 py-1.5 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors cursor-pointer"
                          >
                            Set to {status}
                          </button>
                        ))}
                        ...
                        <button
                          ...
                          className="w-full text-left px-3 py-1.5 text-sm font-bold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-lg transition-colors cursor-pointer flex items-center justify-between"
                        >
                          Delete Page
            ...
            <motion.button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm skeuo-button-primary hover:skeuo-button-primary-hover active:skeuo-button-primary-active rounded-lg font-bold cursor-pointer"
            >
            ...
            <motion.button
              ...
              onClick={fetchLeads}
              disabled={isLoading}
              className="flex items-center gap-2 px-4 py-2 text-sm skeuo-button hover:skeuo-button-hover active:skeuo-button-active rounded-lg font-semibold text-slate-700 dark:text-slate-200 cursor-pointer disabled:opacity-50"
            >
              <motion.span
